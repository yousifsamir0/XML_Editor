...
JSONviewer::JSONviewer(QWidget *parent)
    : QDialog(parent), ui(new Ui::JSONviewer) {
  ui->setupUi(this);
}

JSONviewer::~JSONviewer() { delete ui; }

void JSONviewer::on_pushButton_clicked() {
  QString filename = QFileDialog::getSaveFileName(
      this, "Save As...", "filename", "JSON files (*.json)");
  QFile file(filename);
...
void JSONviewer::on_pushButton_2_clicked() { this->close(); }
