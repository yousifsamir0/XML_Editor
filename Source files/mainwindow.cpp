...
void MainWindow::on_actionOpen_triggered() {
  QString filename = QFileDialog::getOpenFileName(
      this, "Select XML file to Open", "/New_XML", "XML files (*.xml)");
  openfile(filename);
}

void MainWindow::on_actionSave_As_triggered() {
  QString filename = QFileDialog::getSaveFileName(
      this, "Save As...", "filename", "XML files (*.xml)");
  QFile file(filename);
...
void MainWindow::on_actionopen_compressed_file_triggered() {
  QString filename = QFileDialog::getOpenFileName(
      this, "Select XML file to Open", "/New_XML", "CXL files (*.cxl)");
  if (filename == "")
    return;
...
void MainWindow::traverse(Node *root) {
  ...
  std::cout << "==========================================================="
            << std::endl;
  // std::cout << "==========================================================="
  // << std::endl; std::cout << "comment : " + root->comment << std::cout<<
  // "\nnum_childern:" << root->children.size() << std::endl; for (auto i :
  // root->children) {
